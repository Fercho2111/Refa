...
{
    public partial class smEdiClientes : Form
    {
        public smEdiClientes()
        {
            InitializeComponent();
        }
        ...
        private void btnactualiza_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Respuesta == DialogResult.Yes)
                {
                    ...
                    string consulta = "UPDATE Clientes SET  Nombre='" + Nombre + "', Direccion='" + Direccion + "',Telefono='" + Telefono + "',LimCredito='" + LCredito + "' WHERE IdClientes='" + IdCLiente + "' ";
                    SqlCommand comando = new SqlCommand(consulta, sqlcon);
                    int cant;
